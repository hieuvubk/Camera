...
public class FilmMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fuji_c200Count.setText(countImage(Environment.getExternalStorageDirectory() + "/fuji_c200") + " / 24");
        kodak_colorplus200Count.setText(countImage(Environment.getExternalStorageDirectory() + "/kodak_colorplus200") + " / 24");
        kodak_proimage100Count.setText(countImage(Environment.getExternalStorageDirectory() + "/kodak_proimage100") + " / 24");
    }
    ...
    public void choose_kodak_proimage100(View view) throws JSONException {
        ...
        data.put("count", countImage(Environment.getExternalStorageDirectory() + "/kodak_proimage100"));
        data.put("name", getString(R.string.kodak_proimage100_name));
        data.put("path", Environment.getExternalStorageDirectory() + "/kodak_proimage100/");
    ...
    public void choose_kodak_colorplus200(View view) throws JSONException {
        ...
        data.put("symbol", "kodak_colorplus200");
        data.put("filter", Filter.KODAK_COLORPLUS);
        data.put("count", countImage(Environment.getExternalStorageDirectory() + "/kodak_colorplus200"));
        data.put("name", getString(R.string.kodak_colorplus200_name));
        data.put("path", Environment.getExternalStorageDirectory() + "/kodak_colorplus200/");
    ...
    public void choose_fuji_c200(View view) throws JSONException {
        ...
        data.put("count", countImage(Environment.getExternalStorageDirectory() + "/fuji_c200"));
        data.put("name", getString(R.string.fuji_c200_name));
        data.put("path", Environment.getExternalStorageDirectory() + "/fuji_c200/");
...
//        File dir = context.getDir(filmName, Context.MODE_PRIVATE);
        File dir = new File(filmName);
        File dir2 = new File(filmName + "_negative");
        if(!dir2.exists())
            dir2.mkdir();
        if(!dir.exists()) {
            dir.mkdir();
